{
  ...
  srcDmg = fetchurl {
    ...
    url = "https://downloads.claude.ai/releases/darwin/universal/${version}/Claude-208c9a5d28ac54e2e12e93a9f6e1cd3019cfadbf.dmg";
    hash = "sha256-yNFhlPEQGItbjPOyy6YX71sg+iWc2Na4nFlJ6K680Rc=";
  };
in
