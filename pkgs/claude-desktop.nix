{
  ...
  srcDmg = fetchurl {
    ...
    url = "https://downloads.claude.ai/releases/darwin/universal/${version}/Claude-af393cbac809fe788a4d156cb076b0e3e2b1160e.dmg";
    hash = "sha256-SVGJHZHnERTtKrXzmZDHcpZumpLDA/YTCdNBW0fzdNM=";
  };
in
