{
  ...
  srcDmg = fetchurl {
    ...
    url = "https://downloads.claude.ai/releases/darwin/universal/${version}/Claude-495628f91fbfa276fabd6da835ba226fdf5ec68e.dmg";
    hash = "sha256-OcgyvDxok2UR6+mqOe25dhJcGuW4s/FshM95gjGu96M=";
  };
in
