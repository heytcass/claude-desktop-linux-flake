{
  ...
  srcDmg = fetchurl {
    ...
    url = "https://downloads.claude.ai/releases/darwin/universal/${version}/Claude-35ba627070760971ccaab1e700a1c601e9e940cb.dmg";
    hash = "sha256-R/XdC1cL3WBKCmRVKc0fVLDds4FQsHdFNMJqqis5J1c=";
  };
in
