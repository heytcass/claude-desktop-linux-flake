{
  ...
  srcDmg = fetchurl {
    ...
    url = "https://downloads.claude.ai/releases/darwin/universal/${version}/Claude-8f7c53e009d62927d53b39524d8fd204b2bb8b10.dmg";
    hash = "sha256-BcxCmnFsk1/LR9U8ryDcknruoK4BSWai6fgHBm2TDUE=";
  };
in
