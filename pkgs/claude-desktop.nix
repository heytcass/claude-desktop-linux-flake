{
  ...
  srcDmg = fetchurl {
    ...
    url = "https://downloads.claude.ai/releases/darwin/universal/${version}/Claude-648bf5d398e0cfa0a1bb1f8d93c80bb638c85bd2.dmg";
    hash = "sha256-78Aabgc+USlatsJCPWo1jbrXQyXDvVTA7eTR5ENcIsE=";
  };
in
