{
  ...
  srcDmg = fetchurl {
    ...
    url = "https://downloads.claude.ai/releases/darwin/universal/${version}/Claude-71a7aee7e4c1ab9eb313dc3051d72cf09be28d70.dmg";
    hash = "sha256-XXzPExG8D6oDU0FSYOS/K+HBjJKHIsi7vXv4sWq7w/U=";
  };
in
