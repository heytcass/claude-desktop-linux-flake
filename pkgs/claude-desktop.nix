{
  ...
  srcDmg = fetchurl {
    ...
    url = "https://downloads.claude.ai/releases/darwin/universal/${version}/Claude-c2a39e9c82f5a4d51f511f53f532afd276312731.dmg";
    hash = "sha256-2nUTZ8Vxyi64I/Xrp0RWJVw3aBKb4Nw3sp7DNFqw39k=";
  };
in
